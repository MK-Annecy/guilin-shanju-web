/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 86c585287879be64931eb3f09257801f)
// Runtime types generated with workerd@1.20260611.1 2026-05-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	TURNSTILE_SITE_KEY: "0x4AAAAAADkiRMbVH646fdR0";
	EMAIL_FROM: "Booking <noreply@forestretreat.cn>";
	HOTEL_INBOX: "service@forestretreat.cn";
	NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITE_KEY" | "EMAIL_FROM" | "HOTEL_INBOX" | "NEXTJS_ENV">> {}
}
